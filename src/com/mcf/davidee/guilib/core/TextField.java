...
public abstract class TextField extends FocusableWidget {
	...
	//	tessellator.getWorldRenderer().sta;
		//int[] add = {x1,x2,0};
		worldRenderer.addVertexData(new int[]{x1,y2,0});
		worldRenderer.addVertexData(new int[]{x2,y2,0});
		worldRenderer.addVertexData(new int[]{x2,x1,0});
		worldRenderer.addVertexData(new int[]{x1,y1,0});
